...
class SerialReaderTest:
    def __init__(self):
        ...
        self.test_lines = [
            ...
            b"\x02\x01\x00\x20\x00\x0C\x3D\xF6",
            b"\x02\x01\x02\x80\x02\x1D\xFD",  # ReadCoils (1)
            b"\x01\x02\x01\xF4\x00\x20\x39\xDC",
            b"\x01\x02\x02\x05\x00\xBA\xE8",  # ReadDiscreteInputs
            b"\x01\x05\x00\x64\xFF\x00\xCD\xE5",
            b"\x01\x05\x00\x64\xFF\x00\xCD\xE5",  # WriteSingleCoil
            b"\x11\x0F\x00\x13\x00\x0A\x02\xCD\x01\xBF\x0B",
            b"\x11\x0F\x00\x13\x00\x0A\x26\x99"  # WriteMultipleCoils
        ]
